...
function ContactPage() {
    ...
    const handleSubmit = async (e)=>{
        ...
        setStatus(null);
        try {
            const res = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].post('/api/public/contact-submit', formData);
            if (res.data.success) {
                setStatus({
                    type: 'success',
...
_s(ContactPage, "MEwSmfr/rNtr4stlOMZbtsyWUiA=");
_c = ContactPage;
var _c;
...
//# sourceMappingURL=src_4f4e3b73._.js.map