    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "ParticleBackground.useEffect": ()=>{
            ...
            const createStarTexture = {
                "ParticleBackground.useEffect.createStarTexture": ()=>{
            ...
            const isDarkMode = {
                "ParticleBackground.useEffect.isDarkMode": ()=>document.documentElement.classList.contains('dark')
            }["ParticleBackground.useEffect.isDarkMode"];
            const updateTheme = {
                "ParticleBackground.useEffect.updateTheme": ()=>{
                    const isDark = isDarkMode();
                    const bgColor = isDark ? 0x000000 : 0xFFFFFF;
                    const fogColor = isDark ? 0x000000 : 0xF0F0F0;
                    if (scene) {
                        scene.background = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$build$2f$three$2e$core$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Color"](bgColor);
                        scene.fog = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$build$2f$three$2e$core$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["FogExp2"](fogColor, 0.0008);
                    }
                    if (renderer) {
                    ...
                    materials.forEach({
                        "ParticleBackground.useEffect.updateTheme": (m, i)=>{
                            if (isDark) {
                                ...
                                m.opacity = 0.4;
                                m.blending = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$build$2f$three$2e$core$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["AdditiveBlending"];
                                m.size = [
                                    12,
                                    10,
                                    14,
                                ...
                                m.color.setHSL(h, 0.6, 0.4, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$build$2f$three$2e$core$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["SRGBColorSpace"]);
                            } else {
                                // Light mode: colorful star shapes with textures
                                m.map = starTextures[i % starTextures.length];
                                m.opacity = 0.6;
                                m.blending = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$build$2f$three$2e$core$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["NormalBlending"];
                                m.size = [
                                    10,
                                    8,
                                    12,
                                ...
                                const h = 360 * (i * 0.2) % 360 / 360;
                                m.color.setHSL(h, 0.7, 0.5, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$build$2f$three$2e$core$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["SRGBColorSpace"]);
                            }
                            m.needsUpdate = true;
                        }
                    }["ParticleBackground.useEffect.updateTheme"]);
            ...
            const init = {
                "ParticleBackground.useEffect.init": ()=>{
                    ...
                    for(let i = 0; i < parameters.length; i++){
                        ...
                        materials[i] = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$build$2f$three$2e$core$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["PointsMaterial"]({
                            size,
                            map: texture,
                        ...
                        materials[i].color.setHSL(color[0], color[1], color[2], __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$build$2f$three$2e$core$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["SRGBColorSpace"]);
                        const particles = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$build$2f$three$2e$core$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Points"](geometry, materials[i]);
            ...
            const onWindowResize = {
                "ParticleBackground.useEffect.onWindowResize": ()=>{
            ...
            const onPointerMove = {
                "ParticleBackground.useEffect.onPointerMove": (event)=>{
                    if (event.isPrimary === false) return;
                    mouseX = event.clientX - windowHalfX;
                    mouseY = event.clientY - windowHalfY;
                }
            }["ParticleBackground.useEffect.onPointerMove"];
            const animate = {
            ...
            const render = {
                "ParticleBackground.useEffect.render": ()=>{
                    ...
                    for(let i = 0; i < scene.children.length; i++){
                        ...
                        if (object instanceof __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$build$2f$three$2e$core$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Points"]) {
                    ...
                    for(let i = 0; i < materials.length; i++){
                        ...
                        materials[i].color.setHSL(h, 0.6, 0.4, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$build$2f$three$2e$core$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["SRGBColorSpace"]);
                    }
            ...
            return ({
                "ParticleBackground.useEffect": ()=>{
                    ...
                    renderer?.dispose();
                    materials.forEach({
                        "ParticleBackground.useEffect": (m)=>m.dispose()
                    }["ParticleBackground.useEffect"]);
                }
            })["ParticleBackground.useEffect"];
        }
...
_s(ParticleBackground, "8puyVO4ts1RhCfXUmci3vLI3Njw=");
...
//# sourceMappingURL=src_components_ParticleBackground_tsx_1b3eb300._.js.map